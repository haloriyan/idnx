...
const Privacy = () => {
    useEffect(() => {
        document.title = "Kebijakan Privasi - IDN Express"
    }, []);
        ...
        <>
            ...
            <div className="content">
                <div className={styles.Section}>
                    <div className={styles.SectionTitle} style={{textAlign: 'center',marginBottom: -20}}>Kebijakan Privasi</div>
                    <div style={{fontSize: 14,color: '#8492a6',textAlign: 'center'}}>Data dan privasi Anda sangat penting bagi kami</div>
